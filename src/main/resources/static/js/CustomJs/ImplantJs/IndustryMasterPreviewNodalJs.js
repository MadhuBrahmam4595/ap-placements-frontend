...
//					+ '<td></td></tr>');
					+ '<td><div class="d-flex"><button type="button" class="btn btn-info btn-sm m-1"  onclick="return editdata(\''+bean.industryId+'\');">Edit</button>'
					+ '<button type="button" class="btn btn-danger btn-sm m-1"  onclick="return deletedata(\''+bean.industryId+'\');">Delete</button></div></td>'
					+'</tr>');
			});
