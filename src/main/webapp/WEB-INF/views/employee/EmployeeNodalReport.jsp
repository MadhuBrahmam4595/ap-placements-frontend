...
<%
String employeeNodalReportJwtToken = (String) session.getAttribute("jwtToken");
System.out.println("employeeNodalReportJwtToken=>" + employeeNodalReportJwtToken);

String employeeNodalReportInsCode = (String) session.getAttribute("insCode");
System.out.println("employeeNodalReportInsCode=>" + employeeNodalReportInsCode);

String employeeNodalReportapisUrl = (String) session.getAttribute("apisUrl");
System.out.println("employeeNodalReportapisUrl=>" + employeeNodalReportapisUrl);
%>
...
<script src="./js/CustomJs/EmployeeJs/EmployeeNodalReportJs.js"></script>
...
<script>
var jwtToken = 'Bearer '+'<%=employeeNodalReportJwtToken%>';
var insCode =  '<%=employeeNodalReportInsCode%>';
var baseUrl =  '<%=employeeNodalReportapisUrl%>';
</script>
</head>
<meta charset="UTF-8">
<title>Employee ITI Report</title>
