...
<script src="./js/CustomJs/ImplantJs/ImplantDistReportJs.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.0/xlsx.full.min.js"></script>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
<script>
var jwtToken = '<%=implantDistReportJwtToken%>';
...
<div class="container-fluid border p-2 mt-2 shadow-lg" style="border-radius: 5px;">
		...
		<div class="row m-1">
			<div class="col-4">
				...
				<select id="iticode" class="form-control"  onchange="return filterData();"></select>
			</div>
			<div class="col-4">
