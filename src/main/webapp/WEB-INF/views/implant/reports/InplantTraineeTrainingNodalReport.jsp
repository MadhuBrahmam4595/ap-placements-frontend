<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
String inplantTraineesYearReportJwtToken = (String) session.getAttribute("jwtToken");
System.out.println("inplantTraineesReportJwtToken=>" + inplantTraineesYearReportJwtToken);

String inplantTraineesYearReportApisUrl = (String) session.getAttribute("apisUrl");
System.out.println("inplantTraineesReportApisUrl=>" + inplantTraineesYearReportApisUrl);
%>
<!DOCTYPE html>
<html>
<head>
...
<script src="./js/CustomJs/ImplantJs/InplantTraineeTrainingNodalReportJs.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.0/xlsx.full.min.js"></script>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
<script>
var jwtToken = 'Bearer '+'<%=inplantTraineesYearReportJwtToken%>';
var baseUrl = '<%=inplantTraineesYearReportApisUrl%>';
</script>
</head>
<body>
